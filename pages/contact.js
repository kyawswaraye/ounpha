...
const contact = () => {
    return (
        <Layout title="contact ounpha sausage" keywords={"contact ounpha sausage"}>
            <div className="px-8 dark:bg-primary dark:text-gray-300">
                <div className="py-8">
                    <div className="shadowMd dark:bg-secondary grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-8 mx-auto rounded-lg">
                        <div className="flex flex-col justify-between">
                            <div>
                                <h2 className="text-3xl text-center lg:text-5xl text-light-primary dark:text-color-secondary font-bold leading-tight">Send Us A Message</h2>
                            </div>
                            <div className="mt-8 text-center">
                                <svg className="w-full" dataName="Layer 1" viewBox="0 0 1096 574.74">
                                    <defs>
                                        ...
                                        <pattern id="ad310e25-2b04-44c8-bb7b-982389166780" dataName="New Pattern 3" width="36.88"
                                        ...
                                        <linearGradient x1="462.91" y1="660.68" x2="462.91" y2="559.69" />
                                    </defs>
                                    ...
                                    <g opacity="0.1">
                                        ...
                                        <path
                                            ...
                                            transform="translate(-52 -162.63)" fill="#ffeb3b" />
                                        <path
                                    ...
                                    <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#ffeb3b" opacity="0.1" />
                                    <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#ffeb3b" opacity="0.1" />
                                    <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#ffeb3b" opacity="0.1" />
                                    <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#ffeb3b" opacity="0.1" />
                                    <path
                                        ...
                                        transform="translate(-52 -162.63)" fill="#ffeb3b" opacity="0.1" />
                                    <path
                        ...
                        <div className="px-8">
                            <div>
                                ...
                                <input className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outlineNone focus:shadow-outline"
                            ...
                            <div className="mt-8">
                                ...
                                <textarea
                                    className="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outlineNone focus:shadow-outline"></textarea>
                            </div>
                            <div className="mt-8">
                                <button
                                    className="uppercase text-sm font-bold tracking-wide dark:bg-primary dark:text-gray-300 border border-light-secondary dark:border-color-secondary dark:hover:bg-color-secondary dark:hover:text-gray-900 hover:bg-light-secondary hover:text-gray-100 p-3 rounded-lg w-full focus:outlineNone focus:shadow-outline">
                                    Send Message
                                </button>
                            </div>
                        </div>
